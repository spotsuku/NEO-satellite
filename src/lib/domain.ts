...
export const TRIGGER_CRITERIA: Record<string, string> = {
  ...
  T3: "地域の旗を振る事務局リーダー（若手人材）が決まり、本人が旗振り役を引き受けている。",
  T4: "準備室5ロール（現地紹介者・オーナー企業候補・学生リーダー候補・大学高校関係者・自治体関係者）がすべて「確保」になっている。充足すると成立提案バナーが出るが、確定は人の記録操作。",
...
export const TRIGGER_CHECKLIST: Record<string, string[]> = {
  ...
  T8: ["ステータス「確定」の加盟金合計が拠点目標に到達する", "T1成立から90日以内にクリアする"],
