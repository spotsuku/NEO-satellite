...
export const MOCK_BUNDLE: RawBundle = {
  ...
  triggers: [
    ...
    { code: "T3", name: "会長・事務局リーダー確定", description: "会長と若手リーダーの二枚看板が決まる", is_clock_start: false, auto_rule: null, sort: 3 },
